...
const std::string filterCachedString("Cached");
const std::string filterShmemString("Shmem");
const std::string filterSRecString("SReclaimable");
...
long int CpuUtilization(int pid);
};  // namespace LinuxParser
